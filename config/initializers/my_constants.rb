...
SEASON_ATTRIBUTES = %i[id air_date season_number name overview still_path vote_average episode_count].freeze
EPISODE_ATTRIBUTES = %i[id air_date episode_number name overview season_number still_path vote_average].freeze
PERSON_ATTRIBUTES = %i[id name known_for_department popularity profile_path job].freeze
